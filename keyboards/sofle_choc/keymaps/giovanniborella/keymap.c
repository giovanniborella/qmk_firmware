 ...
 * |  -   |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   -  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            |      | LOPT | BKSCP |LOWER | /Enter  /       \      \  |LOWER | Enter |      |      |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
...
[_QWERTY] = LAYOUT(
    ...
    KC_NUBS,   HOME_A, HOME_S,  HOME_D,  HOME_F,  KC_G,                       KC_H,     HOME_J,   HOME_K,  HOME_L,  HOME_SCLN, KC_QUOT,
    DT_DOWN,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_MPLY,   _______, KC_N,     KC_M,     KC_COMM, KC_DOT,  KC_SLSH, DT_UP,
                      _______, DT_PRNT, KC_BSPC, LT(_LOWER,KC_SPC), _______,    _______, LT(_LOWER,KC_SPC), KC_ENT,  _______, _______
),
/* LOWER
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  | LAt  | LCtl |LShift|      | Caps |-------.    ,-------|      | Left | Down | Right|  Del |   |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
